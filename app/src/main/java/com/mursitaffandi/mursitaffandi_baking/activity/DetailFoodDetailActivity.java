 ...
 */
public class DetailFoodDetailActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detailfood_detail);
        ...
        if (savedInstanceState == null) {
            ...
            arguments.putString(DetailFoodDetailFragment.ARG_ITEM_ID,
                    getIntent().getStringExtra(DetailFoodDetailFragment.ARG_ITEM_ID));
            DetailFoodDetailFragment fragment = new DetailFoodDetailFragment();
            fragment.setArguments(arguments);
            getSupportFragmentManager().beginTransaction()
                    .add(R.id.detailfood_detail_container, fragment)
                    .commit();
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            ...
            //
            navigateUpTo(new Intent(this, DetailFoodListActivity.class));
            return true;
        }
